...
.register-wrapper { display: flex; align-items: flex-start; gap: 2rem; max-width: 820px; width: 100%; animation: fadeUp .4s ease both; }
@keyframes fadeUp { from { opacity: 0; transform: translateY(20px); } to { opacity: 1; transform: translateY(0); } }
.reg-form-col { flex: 1; background: #fff; border-radius: 16px; box-shadow: 0 8px 32px rgba(75,40,130,.18); padding: 2rem 2.2rem; }
...
.field input, .field select {
    width: 100%; padding: .62rem .9rem; border: 1.5px solid var(--border);
    border-radius: 8px; font-size: .88rem; font-family: inherit;
    color: #333; background: #fafafa; transition: border-color .2s, box-shadow .2s; appearance: auto;
}
.field input:focus, .field select:focus {
    outline: none; border-color: var(--purple);
    box-shadow: 0 0 0 3px rgba(75,40,130,.12); background: #fff;
}
.field label { display: block; font-size: .72rem; color: var(--muted); margin-top: .25rem; }
.btn-register {
    display: block; width: 160px; margin: 1.2rem auto 0; padding: .7rem;
    background: var(--purple); color: #fff; border: none; border-radius: 8px;
    font-size: .9rem; font-family: inherit; font-weight: 600; cursor: pointer;
...
.reg-illus { width: 200px; flex-shrink: 0; display: flex; flex-direction: column; align-items: center; gap: 1rem; padding-top: 3.5rem; }
.mock-card { background: #f0ecfa; border-radius: 12px; padding: 1rem; text-align: center; width: 100%; }
.mock-avatar { width: 40px; height: 40px; background: var(--purple); border-radius: 50%; margin: 0 auto .5rem; display: flex; align-items: center; justify-content: center; color: #fff; font-size: 1rem; }
.mock-dots { color: #b0a0d0; font-size: 1rem; letter-spacing: 3px; margin-bottom: .3rem; }
.mock-su { background: var(--danger); color: #fff; border: none; border-radius: 6px; padding: .25rem .7rem; font-size: .72rem; font-weight: 600; cursor: default; }
@media (max-width: 640px) { .register-wrapper { flex-direction: column; } .reg-illus { width: 100%; padding-top: 0; } }
</style>
</head>
<body>
<nav>
    ...
    <div class="register-wrapper">
        ...
        <div class="reg-illus">
            <svg viewBox="0 0 200 230" width="190" xmlns="http://www.w3.org/2000/svg">
                ...
                <text x="150" y="161.5" font-size="5.5" fill="#fff" text-anchor="middle" font-family="sans-serif" font-weight="700">Sign Up</text>
                ...
                <path d="M73 98 Q80 104 87 98" fill="none" stroke="#c0392b" stroke-width="1.5" stroke-linecap="round"/>
                <line x1="102" y1="83" x2="126" y2="83" stroke="#4B2882" stroke-width="1.8" stroke-dasharray="4,2"/>
                <polygon points="126,80 132,83 126,86" fill="#4B2882"/>
            </svg>
            <div class="mock-card">
                <div class="mock-avatar">&#128100;</div>
                <div class="mock-dots">&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;</div>
                <div class="mock-dots" style="color:#d0c0f0;font-size:.85rem;">&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;</div>
